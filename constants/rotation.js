    ...
    recepcion: [
      {
        ...
        id: "P1",
        initCoord: { x: "68%", y: "75%" },
        finalCoord: { x: "68%", y: "75%" },
      },
      {
        pos: 2,
        id: "C2",
        initCoord: { x: "71%", y: "63%" },
        finalCoord: { x: "40%", y: "60%" },
      },
      {
        pos: 3,
        id: "O",
